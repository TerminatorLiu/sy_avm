...
GLuint rotate_all_view_depth_render_buffer;

GLuint rotate_fb_view_texture;
GLuint rotate_fb_view_frame_buffer;
GLuint rotate_fb_view_depth_render_buffer;

GLuint rotate_lr_view_texture;
GLuint rotate_lr_view_frame_buffer;
GLuint rotate_lr_view_depth_render_buffer;
...
void DrawLRView(int view_mode)
{
    ...
    float texcoord_view_l[] =
    {
        0.1f,  0.1f,  // left-top
        0.1f,  0.9f,  // right-top
        0.9f,  0.1f,  // left-buttom
        0.9f,  0.9f,  // right- buttom
    };

    float texcoord_view_r[] =
    {
        0.9f,  0.9f,  // left-top
        0.9f,  0.1f,  // right-top
        0.1f,  0.9f,  // left-buttom
        0.1f,  0.1f,  // right- buttom
    };
    ...
    glViewport(0, 0, g_lr_single_view.width, g_lr_single_view.height);
...
void DrawFBView(int view_mode)
{
    ...
    glViewport(0, 0, g_fb_single_view.width, g_fb_single_view.height);
...
int AvmInit(safImgRect allView, safImgRect singleView)
{
    ...
    g_all_view.x = 560;
    g_all_view.y = 360;
    g_all_view.width = 360;
    g_all_view.height = 720;

    g_lr_single_view.x = 560;
    g_lr_single_view.y = 0;
    g_lr_single_view.width = 360;
    g_lr_single_view.height = 720;

    g_fb_single_view.x = 0;
