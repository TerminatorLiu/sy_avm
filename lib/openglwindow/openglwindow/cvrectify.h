...
CVAPI(void)
initChessBoardPoints(int cam_id,const CvSeq* image_points_seq,CvMat* image_points, CvMat* object_points, PARA_FIELD para_field);
...
cvFindChessboardCorners_instExt( const void* arr, CvSize pattern_size,CvPoint2D32f *out_corners,
								...
								PARA_FIELD para_field,int cam_id );
CVAPI(int)
cvFindSquareCorners( const void* arr, CvPoint2D32f *square0,PARA_FIELD para_field,
