...
extern SimplifyCamParams SimplifyleftCamParams;
extern SimplifyCamParams SimplifyrightCamParams;
...
//#define PARADIR "../test/jiaobanche/pku.xml"//"pku.xml"
//#define PARADIR "/home/lk/project/qtTest/test/jiaobanche/pku.xml"
//#define PARADIR1 "/media/usb1p1/pku.txt"//"pku.xml"

#define HEAVY_DIR "./test/jiaobanche/heavy.xml"//"pku.xml"
#define EMPTY_DIR "./test/jiaobanche/empty.xml"//"pku.xml"
...
void readParamsXML(int flag)
{
	...
	cvReadRawData(fs_read_xml,mat_node,SimplifyfrontCamParams.mrInt,"i");

	mat_node = cvGetFileNodeByName(fs_read_xml,NULL,"A2");
	cvReadRawData(fs_read_xml,mat_node,SimplifyfrontCamParams.mtInt,"i");

	mat_node = cvGetFileNodeByName(fs_read_xml,NULL,"A3");
	cvReadRawData(fs_read_xml,mat_node,SimplifyrearCamParams.mrInt,"i");

	mat_node = cvGetFileNodeByName(fs_read_xml,NULL,"A4");
	cvReadRawData(fs_read_xml,mat_node,SimplifyrearCamParams.mtInt,"i");

	mat_node = cvGetFileNodeByName(fs_read_xml,NULL,"A5");
	cvReadRawData(fs_read_xml,mat_node,SimplifyleftCamParams.mrInt,"i");

	mat_node = cvGetFileNodeByName(fs_read_xml,NULL,"A6");
	cvReadRawData(fs_read_xml,mat_node,SimplifyleftCamParams.mtInt,"i");

	mat_node = cvGetFileNodeByName(fs_read_xml,NULL,"A7");
	cvReadRawData(fs_read_xml,mat_node,SimplifyrightCamParams.mrInt,"i");

	mat_node = cvGetFileNodeByName(fs_read_xml,NULL,"A8");
	cvReadRawData(fs_read_xml,mat_node,SimplifyrightCamParams.mtInt,"i");

	mat_node = cvGetFileNodeByName(fs_read_xml,NULL,"B1");
	cvReadRawData(fs_read_xml,mat_node,SimplifyfrontCamParams.mimdInt,"i");

	mat_node = cvGetFileNodeByName(fs_read_xml,NULL,"B2");
	cvReadRawData(fs_read_xml,mat_node,SimplifyrearCamParams.mimdInt,"i");

	mat_node = cvGetFileNodeByName(fs_read_xml,NULL,"B3");
	cvReadRawData(fs_read_xml,mat_node,SimplifyleftCamParams.mimdInt,"i");

	mat_node = cvGetFileNodeByName(fs_read_xml,NULL,"B4");
	cvReadRawData(fs_read_xml,mat_node,SimplifyrightCamParams.mimdInt,"i");
...
{
	//CvFileStorage* fs_write_xml = cvOpenFileStorage(PARADIR,NULL,CV_STORAGE_WRITE);//memstorage-->NULL hxy
	TiXmlDocument xml(EMPTY_DIR);
	if(!xml.LoadFile()){
